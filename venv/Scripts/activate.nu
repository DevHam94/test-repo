...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\admin\PycharmProjects\git-lecture\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\admin\PycharmProjects\git-lecture\venv\Scripts\deactivate.nu'
